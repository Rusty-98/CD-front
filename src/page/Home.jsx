...
const Home = () => {
    ...
    return (
        <div className='w-full h-screen bg-[#135f53] flex items-center justify-center'>
            <div className='w-[40vw] h-[40vh] bg-black border-2 border-white rounded-2xl shadow-black shadow-md flex flex-col items-center justify-center'>
                <div className='w-full h-full border-2 border-[#135f53] rounded-2xl flex flex-col gap-6 items-center pt-5'>
                    ...
                    <div className="flex items-center">
                        <h1 className="text-xl text-white text-left">If not have Room Id Generate here: </h1>
